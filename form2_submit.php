<?phpsession_start();$_SESSION['error_message'] = array();
...
if(!isset($_POST) || !isset($_POST['form_id'])                   
    ...
    if( empty($_POST['prenom']) ) {  $_SESSION['error_message'][] = 'Prénom manquant !';
    }
    else { 
    ...
    if( !empty($_SESSION['error_message'] )) {  
        ...
        if($nb_insert == 0) {    
         ...
         //Confirmation de l'insertion  
            ...
            echo '<html><head><meta charset="utf-8"><title>Confirmation</title></head>
            <body>        
                <h2>Données enregistrées</h2>
                <a href="form1_show.php">Retour</a>      
            </body></html>';  
        }
    }